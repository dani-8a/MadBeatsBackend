...
public class KeyUtils {
    ...
    private KeyPair getKeyPair(String publicKeyPath, String privateKeyPath) {
        ...
        if (publicKeyFile.exists() && privateKeyFile.exists()) {
            System.out.printf("loading keys from file: {}, {}", publicKeyPath, privateKeyPath);
            try {
        ...
        try {
        	System.out.printf("Generating new public and private keys: {}, {}", publicKeyPath, privateKeyPath);
